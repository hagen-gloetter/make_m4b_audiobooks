#! /bin/bash
# hg_make-m4b-Audiobook_working_v2.sh
# Script to convert a directory of MP3 files to a single M4B audiobook file.
# Requires ffmpeg to be installed.
# Author:
# hagen@gloetter.de
# Usage: 
# c:\work\make_m4b_audiobooks\hg_make-m4b-Audiobook_working.sh c:\work\make_m4b_audiobooks\test
# c:\work\make_m4b_audiobooks\hg_make-m4b-Audiobook_working.sh c:\work\make_m4b_audiobooks\test\test2
